...
export const TOOL_AI_INFO: Record<string, ToolAIInfo> = {
  ...
  photographer: {
    ...
    primaryAI: "moondream",
    technologies: [
      "Moondream VLM (trigger evaluation)",
      "Natural language trigger matching",
    ],
    howItWorks: "Polls camera frames every 1-2 seconds, sending them to Moondream with your trigger descriptions. The model returns which trigger (if any) matches the scene. Supports both preset triggers (wave, smile, thumbs up) and custom natural language triggers.",
    educationalNote: "Currently cloud-only for flexibility. Future optimization: Standard gestures (wave, peace, thumbs up) could use Vision's VNDetectHandPoseRequest for real-time on-device detection, reserving Moondream only for custom triggers.",
    requiresApiKey: true,
    isOnDevice: false,
  },
  huntfind: {
...
export const ONBOARDING_SLIDES = [
  {
    ...
    description: "This app demonstrates different AI technologies for computer vision - showing when to use on-device models vs cloud APIs.",
    icon: "eye",
  },
  {
    id: "on-device",
    ...
    description: "Apple Vision excels at people and faces. YOLOv8 detects 80 common objects. Both run on your iPhone's Neural Engine at 30fps - your images never leave your device.",
    icon: "smartphone",
  ...
  },
  {
    ...
    description: "Moondream understands custom descriptions like 'person in red shirt' that pre-trained models can't handle. Use it when on-device models aren't enough.",
    icon: "cloud",
    examples: ["AI Photographer", "Custom Object Search"],
  },
  {
    id: "hybrid",
    title: "Smart Routing",
  ...
  },
  {
    ...
    description: "Tap the ℹ️ icon on any tool to see exactly which AI powers it and why that choice was made.",
    icon: "info",
  },
];
